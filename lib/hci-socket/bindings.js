...
NobleBindings.prototype.initHci = function()
{
  console.log("HCI INIT");
  if (this._hci == null) {
    this._hci = new Hci();
...
NobleBindings.prototype.deinitHci = function()
{
  console.log("DEINIT HCI");
  if (this._hci != null) {
    this._hci.removeAllListeners();
    delete this._hci;
    this._hci = null;
    this._gap.removeAllListeners();
    delete this._gap;
    this._gap = null;
  }
}
